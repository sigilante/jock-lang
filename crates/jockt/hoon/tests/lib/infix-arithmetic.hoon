...
++  test-tokenize
  %+  expect-eq:test
    !>  ^-  (list token-body:jock)  ~[[%punctuator %'['] [%punctuator %'('] [%literal [[%number p=41] q=%.n]] [%punctuator %'+'] [%literal [[%number p=5] q=%.n]] [%punctuator %')'] [%punctuator %'-'] [%literal [[%number p=4] q=%.n]] [%punctuator %'('] [%literal [[%number p=126] q=%.n]] [%punctuator %'*'] [%literal [[%number p=2] q=%.n]] [%punctuator %')'] [%punctuator %'/'] [%literal [[%number p=6] q=%.n]] [%punctuator %'('] [%punctuator %'('] [%literal [[%number p=6] q=%.n]] [%punctuator %'*'] [%punctuator %'*'] [%literal [[%number p=2] q=%.n]] [%punctuator %')'] [%punctuator %'+'] [%literal [[%number p=6] q=%.n]] [%punctuator %')'] [%punctuator %'%'] [%literal [[%number p=100] q=%.n]] [%punctuator %'('] [%literal [[%number p=2] q=%.n]] [%punctuator %'*'] [%punctuator %'*'] [%literal [[%number p=5] q=%.n]] [%punctuator %')'] [%punctuator %'+'] [%literal [[%number p=10] q=%.n]] [%literal [[%number p=1] q=%.n]] [%punctuator %'+'] [%literal [[%number p=2] q=%.n]] [%punctuator %'+'] [%literal [[%number p=39] q=%.n]] [%punctuator %'('] [%literal [[%number p=50] q=%.n]] [%punctuator %'-'] [%literal [[%number p=9] q=%.n]] [%punctuator %')'] [%punctuator %'+'] [%literal [[%number p=1] q=%.n]] [%punctuator %']']]
