...
++  test-jeam
  %+  expect-eq:test
    !>  ^-  jock:jock
        [%let pos=[0 0] type=[p=[%none p=~] name='a'] val=[%list type=[%none p=~] val=~[[%atom p=[[%number p=100] q=%.n]] [%atom p=[[%number p=200] q=%.n]] [%atom p=[[%number p=300] q=%.n]] [%atom p=[[%number p=400] q=%.n]] [%atom p=[[%number p=500] q=%.n]] [%atom p=[[%number p=0] q=%.n]]]] next=[%let pos=[0 0] type=[p=[%list type=[[p=[p=[%atom p=%number q=%.n] name=''] q=[p=[%atom p=%number q=%.n] name='']] name='']] name='b'] val=[%list type=[%none p=~] val=~[[p=[%atom p=[[%number p=10] q=%.n]] q=[%atom p=[[%number p=20] q=%.n]]] [p=[%atom p=[[%number p=30] q=%.n]] q=[%atom p=[[%number p=40] q=%.n]]] [p=[%atom p=[[%number p=50] q=%.n]] q=[%atom p=[[%number p=60] q=%.n]]] [%atom p=[[%number p=0] q=%.n]]]] next=[p=[%call pos=[0 0] func=[%limb p=~[[%name p=%hoon] [%name p=%snag]]] arg=[~ [p=[%atom p=[[%number p=0] q=%.n]] q=[%limb p=~[[%name p=%a]]]]]] q=[%call pos=[0 0] func=[%limb p=~[[%name p=%hoon] [%name p=%snag]]] arg=[~ [p=[%atom p=[[%number p=2] q=%.n]] q=[%limb p=~[[%name p=%b]]]]]]]]]
    !>  (jeam:jock text)
::
++  test-mint
  %+  expect-eq:test
