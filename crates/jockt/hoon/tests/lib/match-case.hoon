...
++  test-jeam
  %+  expect-eq:test
    !>  ^-  jock:jock
        :: [%let type=[p=[%atom p=%number q=%.n] name='a'] val=[%atom p=[[%number p=3] q=%.n]] next=[%cases value=[%limb p=~[[%name p=%a]]] cases=[n=[p=[%atom p=[[%number p=1] q=%.n]] q=[%atom p=[[%number p=0] q=%.n]]] l=[n=[p=[%atom p=[[%number p=3] q=%.n]] q=[%atom p=[[%number p=42] q=%.n]]] l=~ r=~] r=[n=[p=[%atom p=[[%number p=2] q=%.n]] q=[%atom p=[[%number p=21] q=%.n]]] l=[[p=[%atom p=[[%number p=4] q=%.n]] q=[%atom p=[[%number p=63] q=%.n]]]] r=~]] default=[~ [%atom p=[[%number p=84] q=%.n]]]]]
        *jock:jock
    !>  (jeam:jock text)
::
++  test-mint
  %+  expect-eq:test
    !>  [%8 p=[%1 p=3] q=[%8 p=[%1 p=[0 2]] q=[%6 p=[%5 p=[%1 p=1] q=[%0 p=2]] q=[%7 p=[%0 p=3] q=[%1 p=[1 42]]] r=[%6 p=[%5 p=[%1 p=1] q=[%0 p=2]] q=[%7 p=[%0 p=3] q=[%1 p=[1 0]]] r=[%6 p=[%5 p=[%1 p=1] q=[%0 p=2]] q=[%7 p=[%0 p=3] q=[%1 p=[1 63]]] r=[%6 p=[%5 p=[%1 p=1] q=[%0 p=2]] q=[%7 p=[%0 p=3] q=[%1 p=[1 21]]] r=[%7 p=[%0 p=3] q=[%1 p=[1 84]]]]]]]]]
    !>  +>:(mint:jock text)
::
++  test-nock
