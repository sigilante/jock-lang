...
++  test-jeam
  %+  expect-eq:test
    !>  ^-  jock:jock
        [%let pos=[0 0] type=[p=[%none p=~] name='a'] val=[%atom p=[[%number p=1] q=%.n]] next=[%let pos=[0 0] type=[p=[%none p=~] name='b'] val=[%atom p=[[%number p=41] q=%.n]] next=[%let pos=[0 0] type=[p=[%none p=~] name='c'] val=[%atom p=[[%number p=43] q=%.n]] next=[%let pos=[0 0] type=[p=[%none p=~] name='d'] val=[%atom p=[[%number p=6] q=%.n]] next=[%let pos=[0 0] type=[p=[%none p=~] name='e'] val=[%atom p=[[%number p=7] q=%.n]] next=[%let pos=[0 0] type=[p=[%none p=~] name='f'] val=[%atom p=[[%number p=252] q=%.n]] next=[p=[%call pos=[0 0] func=[%limb p=~[[%name p=%hoon] [%name p=%add]]] arg=[~ [p=[%limb p=~[[%name p=%a]]] q=[%limb p=~[[%name p=%b]]]]]] q=[p=[%call pos=[0 0] func=[%limb p=~[[%name p=%hoon] [%name p=%sub]]] arg=[~ [p=[%limb p=~[[%name p=%c]]] q=[%limb p=~[[%name p=%a]]]]]] q=[p=[%call pos=[0 0] func=[%limb p=~[[%name p=%hoon] [%name p=%mul]]] arg=[~ [p=[%limb p=~[[%name p=%d]]] q=[%limb p=~[[%name p=%e]]]]]] q=[%call pos=[0 0] func=[%limb p=~[[%name p=%hoon] [%name p=%div]]] arg=[~ [p=[%limb p=~[[%name p=%f]]] q=[%limb p=~[[%name p=%d]]]]]]]]]]]]]]]
    !>  (jeam:jock text)
::
++  test-mint
  %+  expect-eq:test
